...
public class EmpleadoViewController {
    ...
    private void initDataBinding() {
        ...
        tcEventoAsignado.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().eventoAsignado()));
    }
    ...
    private void mostrarInformacionEmpleado(EmpleadoDto empleadoSeleccionado) {
        if(empleadoSeleccionado != null){
            ...
            txtRol.setText(empleadoSeleccionado.rol());
            txtEventoAsignado.setText(empleadoSeleccionado.eventoAsignado());
        }
    }
    ...
    void nuevoEmpleadoAction(ActionEvent event) {
        ...
        txtRol.setText("Ingrese el rol");
        txtEventoAsignado.setText("Ingrese el evento asignado");
    }
